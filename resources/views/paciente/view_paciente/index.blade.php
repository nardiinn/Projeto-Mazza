...
<div class="row">
	<div class="col-lg-8 col-md-8 col-md-8 col-xs-12">
		<h3>Lista de Pacientes <a href="view_paciente/create"><button class="btn bt-success"> Novo Paciente</button></a></h3>
		...
		<div class="table-responsive">
			<table class="table table-striped table-bordered table-contensed table-hover">
				...
				<tr>
					...
					<td>
						<form>
						<a href="{URL::action ('PacienteController@edit',$pacientes->id_paciente)}"><button class="btn btn-info">Editar</button>
						</a>
						<a href="" data-target="#modal-delete-{{$pacientes->id_paciente}}" data-toglle="modal"><button class="btn btn-danger">Excluir</button>
						</a>
